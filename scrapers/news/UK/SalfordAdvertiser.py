...
feeds = [
    "www.manchestereveningnews.co.uk/news/?service=rss",
    "www.manchestereveningnews.co.uk/?service=rss"
]
header={
...
def article(url):
    ...
    print(bodyCopy)
article("https://www.manchestereveningnews.co.uk/news/greater-manchester-news/bitter-love-triangle-ended-one-21916455")